...
def transfer_npz2tsv(npz_paths, tsv_path):
    ...
    for npz_path in npz_paths:
        ...
        print('Starting transfer {} npz files from {}'.format(len(npz_list), npz_path))
...
if __name__ == '__main__':
    ...
    paths_to_npz_files = [
        '/data/luota/rosita_datasets/imgfeats/mscoco_bua_r101_fix36/npz_files',
        '/data/luota/rosita_datasets/imgfeats/visualgenome_bua_r101_fix36/npz_files',
    ]
    path_to_tsv_files = '/data/luota/rosita_datasets/imgfeats/mscoco_bua_r101_fix36'
    transfer_npz2tsv(paths_to_npz_files, path_to_tsv_files)